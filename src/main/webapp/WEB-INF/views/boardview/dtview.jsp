                    ...
                    <div class="row" style="min-height:500px;">
                        ...
                        <div class="bbs-document-wrap" itemscope="" itemtype="http://schema.org/Article">
                            <div class="bbs-title" itemprop="name">
                                <p>${boardView.dtbtitle}</p>
                            </div>
                            
                            <div class="bbs-detail">
                                <div class="detail-attr detail-writer">
                                    <div class="detail-name">작성자</div>
                                    <div class="detail-value">${boardView.dtbwriter}</div>
                                </div>
                                <div class="detail-attr detail-date">
                                    <div class="detail-name">작성일</div>
                                    <div class="detail-value">${boardView.dtbdate}</div>
                                </div>
                                <div class="detail-attr detail-view">
                                    <div class="detail-name">조회</div>
                                    <div class="detail-value">${boardView.dtbhits}</div>
                                </div>
                            </div>
                            
                            <div class="bbs-content" itemprop="description">
                                <div class="content-view">
                                    ${boardView.dtbcontents}
                                </div>
                            </div>
                            ...
                            <div class="bbs-reply" style="margin:0;">
                                <div class="content-view" style="margin:0;padding:0;">
                                    ...
                                    <tr height="75">
                                        ...
                                        <td style="width:17%;"><button type="button" class="btn btn-info" id="commentWriteBtn">등록</button></td>
                                    </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="bbs-control">
                             <div style="text-align:left;"> 
                                <button type="button" class="btn btn-info" onClick="go_modify();">수정</button>
...
function go_modify() {
    location.href = 'dtboardmodify?bnumber=${boardView.dtbnumber}';
}
function ct_del() {
    if (confirm("정말 댓글을 삭제하시겠습니까??") == true){    //확인
        location.href = 'dtboarddelete';
    }else{   //취소
        return;
    }
}
function go_del(ino) {
    if (confirm("정말로 게시물을 삭제하시겠습니까??") == true){    //확인
        location.href = 'dtboarddelete?bnumber=${boardView.dtbnumber}';
    }else{   //취소
        return;
    }
}
