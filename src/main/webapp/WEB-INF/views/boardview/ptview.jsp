                    ...
                    <div class="row" style="min-height:500px;">
                        ...
                        <div class="bbs-document-wrap" itemscope="" itemtype="http://schema.org/Article">
                            <div class="bbs-title" itemprop="name">
                                <p>${boardView.ptbtitle}</p>
                            </div>
                            
                            <div class="bbs-detail">
                                <div class="detail-attr detail-writer">
                                    <div class="detail-name">작성자</div>
                                    <div class="detail-value">${boardView.ptbwriter}</div>
                                </div>
                                <div class="detail-attr detail-date">
                                    <div class="detail-name">작성일</div>
                                    <div class="detail-value">${boardView.ptbdate}</div>
                                </div>
                                <div class="detail-attr detail-view">
                                    <div class="detail-name">조회</div>
                                    <div class="detail-value">${boardView.ptbhits}</div>
                                </div>
                            </div>
                            
                            <div class="bbs-content" itemprop="description">
                                <div class="content-view">
                                    ${boardView.ptbcontents}
                                </div>
                            </div>
...
function go_modify() {
    location.href ='ptboardmodify?bnumber=${boardView.ptbnumber}';
}
function ct_del() {
    if (confirm("정말 댓글을 삭제하시겠습니까??") == true){    //확인
        location.href = '123bbs_view?bbs=free&mode=ct_del&page=1&field=&so_name=&so_arr=&idx='+ino;
    }else{   //취소
        return;
    }
}
function go_del() {
    if (confirm("정말로 게시물을 삭제하시겠습니까??") == true){    //확인
        location.href ='ptboarddelete?bnumber=${boardView.ptbnumber}';
    }else{   //취소
        return
}
</script>
