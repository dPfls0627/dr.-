...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/lib/se2/dist/js/HuskyEZCreator.js"
					...
					<div class="row" style="min-height: 500px;">
						...
						<div class="bbs-view m_noview">
							...
							<form name="myForm" id="myForm" method="post"
								action="ptboardwrite" enctype="multipart/form-data"
								class="form-inline">
								<table>
									<colgroup>
										<col width="30">
									...
									<tbody>
										<tr>
											...
											<td class="bbs-list-b" colspan="4"><input type="text"
												name="ptbtitle" value="" placeholder="제목 입력란"
										...
										<tr>
											...
											<td class="bbs-list-b"><input type="text"
												name="ptbwriter" placeholder="성 명" class="form-control"
												value="${sessionScope.loginId}" readonly=""></td>
											<td class="bbs-list-blank"></td>
											<td class="bbs-list-a">해시태그</td>
											<td class="bbs-list-b">

												<select name="selectBox" id="selectBox" 
													class="form-control">

													<c:forEach var="hashtag" items="${hashtagList}" varStatus="i">

														<option value="${hashtag.tname}"># ${hashtag.tname}</option>
										...
										<tr>
											...
											<td class="bbs-list-b" colspan="4"><textarea
													id="ptbcontents" name="ptbcontents"
													style="width: 100%; height: 325px; display: none;"></textarea>
							...
							<div style="width: 100%; text-align: right; padding-right: 30px;">
								<button type="button" class="btn btn-warning"
									onclick="go_url('ptboardlist');">작성취소</button>
								<button type="button" class="btn btn-info"
									onclick="go_submits();">작성완료</button>
							</div>
						</div>
						...
						<div class="bbs-view m_view">
									...
									<tbody>
										<tr>
											...
											<td class="bbs-list-a" style="width: 150px;">제 &nbsp;
												&nbsp; 목</td>
											<td class="bbs-list-b"><input type="text"
												name="ptbtitle" value="" placeholder="제 목"
												class="form-control"></td>
										</tr>
										<tr>
											<td class="bbs-list-blank"></td>
										...
										<tr>
											...
											<td class="bbs-list-b"><input type="text"
												class="form-control" value="사진게시판" style="width: 100%;"
												readonly=""></td>
										</tr>
										<tr>
											<td class="bbs-list-b" colspan="3"><textarea
													name="ptbcontents" style="width: 100%; height: 150px;"></textarea>
											</td>
										</tr>
							...
							<div style="width: 100%; text-align: right; padding-right: 30px;">
								<button type="button" class="btn btn-warning"
									onclick="go_url('ptboardlist');">작성취소</button>
								<button type="button" class="btn btn-info"
									onclick="go_submit2();">작성완료</button>
							</div>
