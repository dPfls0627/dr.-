                                ...
                                <div class="block" style="padding-top:5px;">
                                    <div class="row" style="min-height:500px;">
                                        ...
                                        <div class="bbs-view m_noview">
                                            ...
                                            <form name="myForm" id="myForm" method="post" action="dtboardupdateprocess" enctype="multipart/form-data" class="form-inline">
                                                  <table>
                                                    <colgroup>
                                                    <col width="30">
                                                    <col width="150">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="bbs-list-b" colspan="4"><input type="text" name="dtbtitle"  placeholder="제목 입력란" class="form-control" value="${boardUpdate.dtbtitle}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bbs-list-blank"></td>
                                                        <td class="bbs-list-a">성 &nbsp; &nbsp; 명</td>
                                                        <td class="bbs-list-b"><input type="text" name="dtbwriter" placeholder="성 명" class="form-control" value="${boardUpdate.dtbwriter}" readonly=""></td>
                                                        <td class="bbs-list-blank"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="bbs-list-b" colspan="4">
                                                            <textarea id="dtcontents" name="dtbcontents" style="width: 100%; height: 325px; display: none;" >${boardUpdate.dtbcontents}</textarea>
                                                        </td>
                                                    </tr>
                                              ...
                                              <input type="hidden" name="ntbnumber" value="${boardUpdate.dtbnumber}" >
            									</form>
                                             ...
                                             <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="bbs-list-blank" style="width:30px;"></td>
                                                        <td class="bbs-list-a" style="width:150px;">제 &nbsp; &nbsp; 목</td>
                                                        <td class="bbs-list-b"><input type="text" name="dtbtitle" value="" placeholder="제 목" value="${boardUpdate.dtbtitle}" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bbs-list-blank"></td>
                                                        <td class="bbs-list-a">성 &nbsp; &nbsp; 명</td>
                                                    ...
                                                    <tr>
                                                        <td class="bbs-list-b" colspan="3">
                                                            <textarea name="dtbcontents" style="width:100%;height:150px;" >${boardUpdate.dtbcontents}</textarea>
                                                        </td>
                                                    </tr>
