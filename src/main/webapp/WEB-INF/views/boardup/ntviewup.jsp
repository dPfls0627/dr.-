...
<!-- Header Section End -->
                                ...
                                <div class="block" style="padding-top:5px;">
                                    <div class="row" style="min-height:500px;">
                                        ...
                                        <div class="bbs-view m_noview">
                                            ...
                                            <form name="myForm" id="myForm" method="post" action="ntboardupdateprocess" enctype="multipart/form-data" class="form-inline">
                                            <table>
                                                <colgroup>
                                                    <col width="30">
                                                    <col width="150">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="bbs-list-b" colspan="4"><input type="text" name="ntbtitle"  placeholder="제목 입력란" class="form-control" value="${boardUpdate.ntbtitle}"></td>                                                        
                                                    </tr>
                                                    <tr>
                                                        <td class="bbs-list-blank"></td>
                                                        <td class="bbs-list-a">성 &nbsp; &nbsp; 명</td>
                                                        <td class="bbs-list-b"><input type="text" name="ntbwriter" placeholder="성 명" class="form-control" value="${boardUpdate.ntbwriter}" readonly=""></td>
                                                        <td class="bbs-list-blank"></td>
                                                        <td class="bbs-list-a">게시판</td>
                                                        <td class="bbs-list-b"><input type="text" class="form-control" value="공지사항" readonly=""></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="bbs-list-b" colspan="4">
                                                            <textarea id="ntbcontents" name="ntbcontents" style="width: 100%; height: 325px; display: none;">${boardUpdate.ntbcontents}</textarea>
                                                        </td>
                                             ...
                                             <input type="hidden" name="ntbnumber" value="${boardUpdate.ntbnumber}" >
            									</form>
                                            <div style="height:20px;clear:both;"></div>
                                            <div style="width:100%;text-align:right;padding-right:30px;"><button type="button" class="btn btn-warning" onclick="go_url('ntboardlist');">작성취소</button> <button type="button" class="btn btn-info" onclick="go_submits();">작성완료</button></div>
                                        </div>
                                        
            
                                        <div class="bbs-view m_view">
                                          
                                            <form name="myForm2" id="myForm2" method="post" action="ntboardwrite" enctype="multipart/form-data" class="form-inline">
                                              <table>
                                                <colgroup>
                                                    <col width="30">
                                                    <col width="150">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="bbs-list-blank" style="width:30px;"></td>
                                                        <td class="bbs-list-a" style="width:150px;">제 &nbsp; &nbsp; 목</td>
                                                        <td class="bbs-list-b"><input type="text" name="ntbtitle"  placeholder="제 목" class="form-control" value="${boardUpdate.ntbtitle}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bbs-list-blank"></td>
                                                        <td class="bbs-list-a">성 &nbsp; &nbsp; 명</td>
                                                        <td class="bbs-list-b"><input type="text" name="ntbwriter" placeholder="성 명" class="form-control" value="${sessionScope.loginId}" readonly="" value="${boardView.ntbwriter}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bbs-list-blank"></td>
                                                        <td class="bbs-list-a">게시판</td>
                                                        <td class="bbs-list-b"><input type="text" class="form-control" value="공지사항" style="width:100%;" readonly="" ></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bbs-list-b" colspan="3">
                                                            <textarea name="ntbcontents" style="width:100%;height:150px;">${boardUpdate.ntbcontents}</textarea>
                                                        </td>
                                                    </tr>
                                            ...
                                            <div style="width:100%;text-align:right;padding-right:30px;"><button type="button" class="btn btn-warning" onclick="go_url('ntboardlist');">작성취소</button> <button type="button" class="btn btn-info" onclick="go_submit2();">작성완료</button></div>
                ...
                function go_submits() {
                    ...
                    oEditors.getById["ntbcontents"].exec("UPDATE_CONTENTS_FIELD", []);
            
                    var frm = document.myForm;
            
                    if (!frm.ntbtitle.value) {
                        alert("제목을 입력해주세요!");
                        frm.subject.focus();
                        return false;
                    }
