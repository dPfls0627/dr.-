					...
					<div class="inner">
						<nav class="lnb lnb_scroll v3">
							<ul>
								...
								<li><a href="find.html" class="on"><span>아이디/비밀번호 찾기</span></a></li>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button id="btn1" class="btn btn-primary" style="display:none;"><a href="login.html" style="color:white;">로그인하기</a></button>
				</div>
			</div>
		</div>
	</div>
