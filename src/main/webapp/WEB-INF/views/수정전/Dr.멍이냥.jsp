...
<head>
    ...
    <link rel="stylesheet" href="css/flaticonpet.css" type="text/css">
    ...
    <link rel="stylesheet" href="js/jquery.magnific-popup.min.js" type="text/css">
              ...
              <div class="col-lg-12">
                  <nav class="header__menu mobile-menu">
                      <ul>
                          ...
                          <li class="active"><a href="./Dr.멍이냥.html">소개</a></li>
...
<section class="about spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="about__video set-bg" data-setbg="img/class/earth-1617121_1920.jpg">
